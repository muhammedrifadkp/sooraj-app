...
import { FiEdit2, FiTrash2, FiPlus, FiFileText, FiFilter } from 'react-icons/fi';
...
const AdminAssignments: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedDepartment === 'all') {
      ...
      setFilteredAssignments(assignments.filter(assignment => assignment.department === selectedDepartment));
    }
  }, [selectedDepartment, assignments]);
  ...
  const handleEdit = (assignmentId: string) => {
    navigate(`/admin/edit-assignment/${assignmentId}`);
  };
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <FiPlus className="mr-2" /> Add New Assignment
        </button>
      </div>
          ...
          {filteredAssignments.length === 0 ? (
            <div className="text-center py-16">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiFileText className="text-indigo-500 text-3xl" />
              </div>
              ...
              >
                <FiPlus className="mr-2" /> Add your first assignment
              </button>
            </div>
          ) : (
              ...
              {filteredAssignments.map((assignment) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1.5">
                        <span className={`px-2.5 py-1 text-xs font-medium rounded-full ${getDepartmentColor(assignment.department || '')}`}>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {deleteConfirmId === assignment._id ? (
                      <div className="flex items-center space-x-2">
                        <button
                      ...
                      <button
                        onClick={() => setDeleteConfirmId(assignment._id)}
