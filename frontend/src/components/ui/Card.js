...
var Card = React.forwardRef(function (_a, ref) {
    ...
    return (<framer_motion_1.motion.div ref={ref} className={(0, utils_1.cn)('rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-200 hover:shadow-md', className)} whileHover={{ y: -5 }} {...props}/>);
});
exports.Card = Card;
