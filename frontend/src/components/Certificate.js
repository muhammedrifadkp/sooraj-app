...
var Certificate = function (_a) {
    var courseName = _a.courseName, department = _a.department, marks = _a.marks, studentName = _a.studentName, completionDate = _a.completionDate, certificateNumber = _a.certificateNumber, _b = _a.isCourseCompletion, isCourseCompletion = _b === void 0 ? false : _b;
    return (<framer_motion_1.motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-2xl shadow-xl p-8 max-w-4xl mx-auto border-8 border-double border-blue-500">
            <div className="text-center mb-8">
                <div className="flex justify-center mb-4">
                    <div className="bg-blue-100 p-4 rounded-full">
                        <fi_1.FiAward className="text-4xl text-blue-600"/>
                    </div>
                </div>
            ...
            {marks && (<div className="text-center mb-8">
